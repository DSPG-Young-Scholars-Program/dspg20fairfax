...
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent population in labor force over age 16 that is unemployed.png",plot=last_plot())
```
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent population over age 25 without a Bachelor's degree.png",plot=last_plot())
```
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers traveling to work for 30min or more.png",plot=last_plot())
```
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent worker with no vehicle available.png",plot=last_plot())
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by means of transportation to work : Drove alone.png",plot=last_plot())
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by means of transportation to work : Carpooled.png",plot=last_plot())
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by means of transportation to work : Public transport.png",plot=last_plot())
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by means of transportation to work : Walked.png",plot=last_plot())
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by means of transportation to work : Taxicab and other.png",plot=last_plot())
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by means of transportation to work : Worked from home.png",plot=last_plot())
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by occupation : Private company.png",plot=last_plot())
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by occupation : Self-employed in own incorporated business.png",plot=last_plot())
```
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by occupation : Private not-for-profit.png",plot=last_plot())
```
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by occupation : Local, state and federal government.png",plot=last_plot())
```
```{r}
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by occupation : Self-employed in own not incorporated business.png",plot=last_plot())
```
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by industry : Agri, forestry, fishing, hunting, mining.png",plot=last_plot())
```
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by industry : Costruction.png",plot=last_plot())
```
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by industry : Manufacturing.png",plot=last_plot())
```
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by industry : Wholesale trade.png",plot=last_plot())
```
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by industry : Retail trade.png",plot=last_plot())
```
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by industry : Transportation, warehousing, utilities.png",plot=last_plot())
```
```{r}
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by industry : Information.png",plot=last_plot())
```
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by industry : Finance, insurance, real estate. rental, leasing.png",plot=last_plot())
```
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by industry : Professional, scientific, management.png",plot=last_plot())
```
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by industry : Educational services, health care, social assistance.png",plot=last_plot())
```
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by industry : Arts, entertainment, recreation, accomodation, food services.png",plot=last_plot())
```
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by industry : Other services, except public administration.png",plot=last_plot())
```
...
ggplot() +
  ...
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        ...
        legend.position = "right") +
  scale_fill_viridis(name = "Percent")
ggsave(path="/sfs/qumulo/qhome/sr2wm/Git/dspg20fairfax/output/acs/",device="png",filename="Residence tract_Percent workers over age 16 by industry : Public administration.png",plot=last_plot())
```
