...
library(ggplot2)
  ...
  ggplot(data =ACS_data, aes(fill = wrk_pct_16_19)) + 
  geom_sf(color = NA) + 
  coord_sf(crs = 26911) + 
  scale_fill_viridis_c() 
  
  ggplot(data =ACS_data, aes(fill = wrk_pct_20_24)) + 
  geom_sf(color = NA) + 
  coord_sf(crs = 26911) + 
  scale_fill_viridis_c() 
  
  ggplot(data =ACS_data, aes(fill = wrk_pct_25_44)) + 
  geom_sf(color = NA) + 
  coord_sf(crs = 26911) + 
  scale_fill_viridis_c() 
  
  ggplot(data =ACS_data, aes(fill = wrk_pct_45_54)) + 
  geom_sf(color = NA) + 
  coord_sf(crs = 26911) + 
  scale_fill_viridis_c() 
  
  ggplot(data =ACS_data, aes(fill = wrk_pct_55_59)) + 
  geom_sf(color = NA) + 
  coord_sf(crs = 26911) + 
  scale_fill_viridis_c() 
  
  ggplot(data =ACS_data, aes(fill = wrk_pct_60_64)) + 
  geom_sf(color = NA) + 
  coord_sf(crs = 26911) + 
  scale_fill_viridis_c() 
  
  ggplot(data =ACS_data, aes(fill = wrk_pct_65_up)) + 
  geom_sf(color = NA) + 
  coord_sf(crs = 26911) + 
  scale_fill_viridis_c() 
```
