...
plt_wrk_drive <- ggplot() +
  ...
  labs(title = "Percentage of workers that drive to work \nby Census tract, 2014/18",
       caption = "Source: American Community Survey 2014/18 (5-year) estimates.") +
  theme_map() +
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        legend.title = element_text(size = 11, face = "bold"),
...
plt_wrk_carpool <- ggplot() +
  ...
  labs(title = "Percentage of workers that carpool to work \nby Census tract, 2014/18",
       caption = "Source: American Community Survey 2014/18 (5-year) estimates.") +
  theme_map() +
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        legend.title = element_text(size = 11, face = "bold"),
...
plt_wrk_pub_trans <- ggplot() +
  ...
  labs(title = "Percentage of workers that take public transportation to work \nby Census tract, 2014/18",
       caption = "Source: American Community Survey 2014/18 (5-year) estimates.") +
  theme_map() +
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        legend.title = element_text(size = 11, face = "bold"),
...
plt_wrk_walk <- ggplot() +
  ...
  labs(title = "Percentage of workers that walk to work \nby Census tract, 2014/18",
       caption = "Source: American Community Survey 2014/18 (5-year) estimates.") +
  theme_map() +
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        legend.title = element_text(size = 11, face = "bold"),
...
plt_wrk_other <- ggplot() +
  ...
  labs(title = "Percentage of workers that take taxicab, \nmotorcycle, bicycle, or other means to work \nby Census tract, 2014/18",
       caption = "Source: American Community Survey 2014/18 (5-year) estimates.") +
  theme_map() +
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        legend.title = element_text(size = 11, face = "bold"),
...
plt_wrk_none <- ggplot() +
  ...
  labs(title = "Percentage of workers that work from home \nby Census tract, 2014/18",
       caption = "Source: American Community Survey 2014/18 (5-year) estimates.") +
  theme_map() +
  theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
        legend.title = element_text(size = 11, face = "bold"),
