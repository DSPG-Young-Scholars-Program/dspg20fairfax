...
vars <-c(
  ...
  "B08135_007", "B08135_008", "B08135_009", "B08135_010",
  ...
  # class of workers
 "C24060_007", "C24060_013", "C24060_019", "C24060_025", "C24060_031", 

 # industry
 "C24070_002", "C24070_003", "C24070_004","C24070_005", "C24070_006", "C24070_007", "C24070_008", "C24070_009", "C24070_010",
...
ACS_data <- Fairfax %>% transmute(
  ...
  pct_without_bachelors=(1-(B23006_024E/B23025_002E))*100,
  travel_30min = B08135_007E + B08135_008E+ B08135_009E + B08135_010E,
  mean_travel_time= B08135_001E/B23025_002E,
  pct_no_vehicle= (B08141_002E/B23025_002E)*100,
  pct_drove_alone= (B08301_003E/B23025_002E)*100,
  pct_carpooled= (B08301_004E/B23025_002E)*100,
  pct_public_transport= (B08301_010E/B23025_002E)*100,
  pct_walked= (B08301_019E/B23025_002E)*100,
  pct_taxi_other= ((B08301_016E + B08301_017E + B08301_018E + B08301_020E)/B23025_002E)*100,
  pct_worked_home= (B08301_021E/B23025_002E)*100,
  pct_private= (C24060_007E/B23025_002E)*100,
  pct_own_business= (C24060_013E/B23025_002E)*100,
  pct_not_for_profit= (C24060_019E/B23025_002E)*100,
  pct_govt= (C24060_025E/B23025_002E)*100,
  pct_selfEmp_unpaid= (C24060_031E/B23025_002E)*100,
  pct_ag= (C24070_002E/B23025_002E)*100,
  pct_constr= (C24070_003E/B23025_002E)*100,
  pct_manuf= (C24070_004E/B23025_002E)*100,
  pct_wholesale= (C24070_005E/B23025_002E)*100,
  pct_retail= (C24070_006E/B23025_002E)*100,
  pct_transport= (C24070_007E/B23025_002E)*100,
  pct_info= (C24070_008E/B23025_002E)*100,
  pct_fin= (C24070_009E/B23025_002E)*100,
  pct_prof= (C24070_010E/B23025_002E)*100,
  pct_edu= (C24070_011E/B23025_002E)*100,
  pct_arts= (C24070_012E/B23025_002E)*100,
  pct_other= (C24070_013E/B23025_002E)*100,
  pct_pub_admin= (C24070_014E/B23025_002E)*100
)
