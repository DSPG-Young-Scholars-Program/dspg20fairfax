...
res_ACS_tract %>%
  ggplot(aes(fill=res_pct_unempl)) + 
  facet_wrap(~"(B23025_005E/B23025_002E)*100")+
  geom_sf(color=NA)+
  coord_sf(crs=4269)+
...
```{r}
res_ACS_tract %>%
  ggplot(aes(fill=res_pct_without_bachelors)) + 
  facet_wrap(~"(1-(B23006_024E/B23006_001E))*100")+
  geom_sf(color=NA)+
  coord_sf(crs=4269)+
  scale_fill_viridis_c()
```
```{r}
res_ACS_tract %>%
  ggplot(aes(fill=res_travel_30min)) + 
  facet_wrap(~"(B08135_007E + B08135_008E + B08135_009E + B08135_010E)/B08135_001E*100")+
  geom_sf(color=NA)+
  coord_sf(crs=4269)+
  scale_fill_viridis_c()
```
...
```{r}
res_ACS_tract %>%
  ggplot(aes(fill=res_mean_travel_time)) + 
  facet_wrap(~"(0*B08135_002E + 10*B08135_003E + 15*B08135_004E + 20*B08135_005E + 25*B08135_006E + 30*B08135_007E + 35*B08135_008E + 45*B08135_009E +                 60*B08135_010E)/B08135_001E")+
  geom_sf(color=NA)+
  coord_sf(crs=4269)+
  scale_fill_viridis_c()
```
```{r}
res_ACS_tract %>%
  ggplot(aes(fill=res_pct_no_vehicle)) + 
  facet_wrap(~"(B08141_002E/B08141_001E)*100")+
  geom_sf(color=NA)+
  coord_sf(crs=4269)+
  scale_fill_viridis_c()
...
```{r}
res_ACS_tract %>%
  ggplot(aes(fill=res_pct_drove)) + 
  facet_wrap(~"(B08301_003E/B08301_001E)*100)")+
  geom_sf(color=NA)+
  coord_sf(crs=4269)+
  scale_fill_viridis_c()
...
```{r}
res_ACS_tract %>%
  ggplot(aes(fill=res_pct_carpooled)) + 
  facet_wrap(~"(B08301_004E/B08301_001E)*100")+
  geom_sf(color=NA)+
  coord_sf(crs=4269)+
  scale_fill_viridis_c()
...
```{r}
res_ACS_tract %>%
  ggplot(aes(fill=res_pct_transport)) + 
  facet_wrap(~"(B08301_010E/B08301_001E)*100")+
  geom_sf(color=NA)+
  coord_sf(crs=4269)+
  scale_fill_viridis_c()
...
```{r}
res_ACS_tract %>%
  ggplot(aes(fill=res_pct_walked)) + 
  facet_wrap(~"(B08301_019E/B08301_001E)*100")+
  geom_sf(color=NA)+
  coord_sf(crs=4269)+
  scale_fill_viridis_c()
...
```{r}
res_ACS_tract %>%
  ggplot(aes(fill=res_pct_taxi_other)) + 
  facet_wrap(~"((B08301_016E + B08301_017E + B08301_018E + B08301_020E)/B08301_001E)*100")+
  geom_sf(color=NA)+
  coord_sf(crs=4269)+
  scale_fill_viridis_c()
...
```{r}
res_ACS_tract %>%
  ggplot(aes(fill=res_pct_worked_home)) + 
  facet_wrap(~"(B08301_021E/B08301_001E)*100")+
  geom_sf(color=NA)+
  coord_sf(crs=4269)+
  scale_fill_viridis_c()
