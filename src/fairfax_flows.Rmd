...
c("Maryland", "District of Columbia", "West Virginia", "Pennsylvania", "North Carolina", "New Jersey", "New York", "Ohio", "South Carolina", "Florida")
```{r}
library(stplanr)
va_points <- tracts("VA")
md_points <- tracts("MD")
...
shapes <- od2line(filtered_jobs[, 3:22], st_centroid(all_points)[, 4:13])
