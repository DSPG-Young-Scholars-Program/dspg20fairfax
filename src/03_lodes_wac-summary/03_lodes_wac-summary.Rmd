...
va_xwalk <- read.csv("/sfs/qumulo/qhome/sm9dv/dspg20fairfax/data/original/va_xwalk.csv",  colClasses = c("tabblk2010" = "factor"))
...
readable_col <- read.csv("/sfs/qumulo/qhome/sm9dv/dspg20fairfax/data/original/lodes_wac_cols.csv")
