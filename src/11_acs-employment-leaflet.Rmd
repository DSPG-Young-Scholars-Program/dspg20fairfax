...
leaflet(data = ACS_data,options = leafletOptions(minZoom = 10))%>%
  ...
  addLegend("bottomleft", 
            ...
            title = "Percentage of Labor Force <br> with HS Education or Less <br>by Quintile Group", 
            opacity = 1,
            na.label = "Not Available",
...
leaflet(data = ACS_data,options = leafletOptions(minZoom = 10))%>%
  ...
  addLegend("bottomleft", 
            ...
            title = "Median Worker Income in <br> Fairfax County,<br> by Quintile Group", 
            opacity = 1,
            na.label = "Not Available",
...
leaflet(data = ACS_data,options = leafletOptions(minZoom = 10))%>%
  ...
  addLegend("bottomleft", 
            ...
            title = "Percent Employed in Occupations <br>Vulnerable to Covid-19<br> by Quintile Group", 
            opacity = 1,
            na.label = "Not Available",
