...
Our first data source was the [2019 Forbes 1000 List](https://www.someka.net/excel-template/fortune-1000-excel-list/). The Fortune 1000 list is assembled by Fortune Magazine and ranks 1000 of the largest US companies by publicly available revenue amount. The list also includes attributes like revenue change from last year, profits, profit change from last year, assets, market value, number of employees, and previous year's rank for a company. Thirty-five companies with headquarters in Fairfax County appeared in the 66th annual Fortune 1000 list, and 11 of them also made into the Fortune 500 list. We searched for addresses of the 35 Fairfax County companies' headquarters and geocoded headquarters locations.
...
Finally, we retrieve [LEHD Origin-Destination Employment Statistics (LODES)](https://lehd.ces.census.gov/data/) data to calculate the total number of jobs in each Fairfax County census tract. We use the latest available data from 2017 and aggregate job information from workplace census block group to workplace tract level. We use data on the total number of jobs in a given census tract as a base map, and overlay the locations of Fortune 1000 companies and the top 100 largest employers in Fairfax County.
