...
_Interpreting Quantiles: The map visualizes values on the selected indicator at tract level. Counties with darker map colors have higher values on the selected indicator. Conversely, counties with lighter colors have lower values on the selected indicator. To facilitate comparisons and display quintile cut-off points, map colors represent quintile-grouped values._
