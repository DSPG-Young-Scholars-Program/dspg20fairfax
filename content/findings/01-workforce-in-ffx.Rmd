...
This bar chart shows the share of sectors the labor force occupies.  The sector with highest worker density is the Professional, Scientific & Technical services.  This continues the idea that the Fairfax County workforce is generally highly educated, has opportunity to earn, and the majority of employment opportunties will not be impacted by the pandemic.  That is not to say that there will not be pandemic effect; the Healthcare Service and Retail sector are the second and third most employed industries.  There will likely be permenent changes and effects to these sectors, and many workers may have to reskill and find themselves in a new industry.
```{r, echo = F}
