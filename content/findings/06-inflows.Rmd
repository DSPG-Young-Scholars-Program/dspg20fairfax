...
Mention packages used and what they do. 
For the maps, here and when you are describing the maps, mention we are only showing top 10 and that the lines are to shape centroids.
