...
table1 <- data.frame(
  Description = c("Unemployed", "Part-time Workers", "HS or less for Employed Population 16+", 
              "Median Income for Civilian Employed Population 16+",
              "Employed in Occupations Impacted by COVID (Services)", 
...
DT::datatable(table1, colnames = c('Description', 'ACS Table Code'))
````
